...
const TabArr = [
  ...
  { route: 'OrderHistory', label: 'Order', type: Icons.Feather, icon: 'clock', component: OrderHistory },
  { route: 'ListProduct', label: 'Product', type: Icons.Feather, icon: 'list', component: ListProduct },
