...
const Slider = () => {
  ...
  return (
    <View>
      ...
      <TouchableOpacity onPress={handleGetting} style={{height:heightScreen*0.08, width: widthScreen*0.35, position: 'absolute', borderRadius:50, justifyContent: 'center', bottom: heightScreen*0.05, right: widthScreen*0.05, backgroundColor:'#5B9EE1'}}>
